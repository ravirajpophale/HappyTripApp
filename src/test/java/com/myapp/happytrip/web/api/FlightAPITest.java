...
import com.myapp.happytrip.model.Flight;
import com.myapp.happytrip.repository.FlightList;
...
// Prepare Mock Flight
	Flight airline1 = new Flight("AI16H", "INDIGO", "2021-08-30", "2021-08-30", "14:55", "16:30", "Hydrabad",
			"Banglore", 8757, 1);
...
.andExpect(jsonPath("$[0].arrivalLocation", is("Hydrabad")))
.andExpect(jsonPath("$[0].departureLocation", is("Banglore")))
...
// Prepare Mock Flight
Flight airline1 = new Flight("RF12E", "SPICEJET",  "2021-09-20", "2021-09-20", "17:40", "20:05", "America", "India", 2966, 7);
...
String departureLocation = "America";
String arrivalLocation = "India";
...
.andExpect(jsonPath("$[0].arrivalLocation", is("America")))
.andExpect(jsonPath("$[0].departureLocation", is("India")))
